...
|-------------|----------------------|---------------------|
| Time is Geometry | Spectral Theory, Noncommutative Geometry | $\varphi = (mc^2/\hbar)\int d\tau$<br/>Spectral Triple |
| Causality is Partial Order | Category Theory, Topology | Partial Order Relation<br/>Cauchy Surface |
| Boundary is Reality | Noncommutative Geometry, Modular Theory | Boundary Spectral Triple<br/>Brown-York Tensor |
| Scattering is Evolution | Scattering Theory, Spectral Theory | S-Matrix<br/>Birman-Kreĭn Formula |
| Entropy is Arrow | Information Geometry, Modular Theory | Relative Entropy<br/>KMS Condition |
