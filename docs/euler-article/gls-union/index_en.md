...
```mermaid
graph TB
    subgraph "Core Unification Principles"
        IGVP["IGVP<br/>Information Geometry Variational Principle<br/>(Entropy→Gravity)"]
        TimeScale["Unified Time Scale<br/>Scattering=Modular=Geometry"]
        NullMod["Null-Modular Double Cover<br/>Topological Constraints"]
    end

    subgraph "Five Fundamental Concepts"
        Time["Time<br/>The Essence of Flow"]
        Cause["Causality<br/>The Order of Events"]
        Bound["Boundary<br/>The Starting Point of Reality"]
        Scatter["Scattering<br/>The Core of Evolution"]
        Entropy["Entropy<br/>The Direction of the Arrow"]
    end

    subgraph "Unified Scale Identity"
        Unity["κ(ω) = φ'(ω)/π = ρ_rel(ω) = tr Q(ω)/2π<br/><b>Time=Phase=Energy Density=Scattering Delay</b>"]
    end

    subgraph "Three Pillar Theories"
        Boundary["Boundary Theory<br/>Boundary is Reality<br/>Holographic Principle"]
        Causal["Causal Structure<br/>Partial Order=Monotonicity<br/>Observer Consensus"]
        Topo["Topological Theory<br/>Z₂ Constraints<br/>Fermion Origin"]
    end

    subgraph "Ultimate Unification"
        QCA["QCA Universe<br/>Discrete→Continuous<br/>Terminal Object in Category"]
        Matrix["Matrix Universe<br/>Reality=Network<br/>Heart-Universe Isomorphism"]
        Final["Final Unification<br/>Single Variational Principle<br/>δI[U]=0"]
    end

    subgraph "Emergence of Physical World"
        GR["General Relativity<br/>Geometry of Gravity"]
        QFT["Quantum Field Theory<br/>Particles and Fields"]
        SM["Standard Model<br/>Fundamental Interactions"]
        Cosmo["Cosmology<br/>Spacetime Evolution"]
        Life["Life and Consciousness<br/>Self-Referential Observer"]
    end
...
```mermaid
graph LR
    subgraph "Entry Path (Suitable for Everyone)"
        A1["Prologue<br/>Why Do We Need Unified Theory?"]
        A2["Fundamental Concepts<br/>Time, Causality, Boundary, Scattering, Entropy"]
        A3["Core Ideas<br/>Unity of Five in Unified Scale"]
    end

    subgraph "Theoretical Physics Path"
        B1["Mathematical Tools<br/>Spectral Theory, Scattering, Information Geometry"]
        B2["IGVP Framework<br/>Deriving Gravity from Entropy"]
        B3["Unified Time<br/>Unification of Three Times"]
        B4["Final Unification<br/>Single Variational Principle"]
    end

    subgraph "Experimental Physics Path"
        C1["Unified Time<br/>Measurable Time Scale"]
        C2["Boundary Theory<br/>Experimental Setup and Observation"]
        C3["Applications<br/>Black Holes, Gravitational Waves, Neutrinos"]
    end

    subgraph "Philosophical Reflection Path"
        D1["Final Unification<br/>Ontological Picture"]
        D2["Matrix Universe<br/>Nature of Reality"]
        D3["Causal Structure<br/>Observer and Consciousness"]
        D4["Back to Foundations<br/>Understanding Mathematical Details"]
    end
...
**🎓 Have Physics Background? Go Straight to the Core:**
...
### 📖 Part One: Fundamental Concepts (01-foundation/)
...
### 📖 Part Two: Core Ideas (02-core-ideas/)
...
### 📖 Part Three: Mathematical Toolbox (03-mathematical-tools/)
...
### 📖 Part Four: IGVP Framework (04-igvp-framework/)
...
### 📖 Part Five: Unified Time Theory (05-unified-time/)
...
### 📖 Part Seven: Causal Structure (07-causal-structure/)
...
### 📖 Part Eight: Topological Constraints (08-topological-constraints/)
...
- [Z₂ Holonomy](08-topological-constraints/03-z2-holonomy_en.md) - Quantization of Topology
...
### 📖 Part Nine: Quantum Cellular Automaton Universe (09-qca-universe/)
Discrete Universe
...
### 📖 Part Ten: Matrix Universe (10-matrix-universe/)
...
### 📖 Part Eleven: Final Unification (11-final-unification/)
...
### 📖 Part Twelve: Applications and Tests (12-applications/)
...
### 📖 Part Thirteen: Advanced Topics (13-advanced-topics/)
...
```mermaid
graph TD
    subgraph "Level 0: Philosophical Foundation"
        Phil["Ontological Questions<br/>What is Reality?<br/>What is Time?<br/>What is Causality?"]
    end

    subgraph "Level 1: Mathematical Foundation"
        Math["Noncommutative Geometry<br/>Spectral Theory<br/>Category Theory<br/>Topology"]
    end

    subgraph "Level 2: Core Principles"
        Core1["IGVP<br/>Entropy→Gravity"]
        Core2["Unified Time Scale<br/>Scattering=Modular=Geometry"]
        Core3["Null-Modular Double Cover<br/>Topological Constraints"]
    end

    subgraph "Level 3: Unified Framework"
        Frame1["Boundary Time Geometry"]
        Frame2["Causal Structure"]
        Frame3["Self-Referential Scattering"]
    end

    subgraph "Level 4: Cosmic Ontology"
        Onto1["QCA Universe<br/>Terminal Object in Category"]
        Onto2["Matrix Universe<br/>Heart-Universe Isomorphism"]
        Onto3["Single Variational Principle<br/>δI[U]=0"]
    end

    subgraph "Level 5: Physical Emergence"
        Phys1["General Relativity"]
        Phys2["Quantum Field Theory"]
        Phys3["Standard Model"]
        Phys4["Cosmology"]
        Phys5["Condensed Matter"]
        Phys6["Life and Consciousness"]
    end
