...
| 层级 | zeta值 | 数值 | 物理意义 |
|------|--------|------|----------|
| n=0 | $\zeta(-1) = -\frac{1}{12}$ | -0.08333 | 基础维度补偿 |
| n=1 | $\zeta(-3) = \frac{1}{120}$ | 0.00833 | Casimir效应 |
| n=2 | $\zeta(-5) = -\frac{1}{252}$ | -0.003968 | 量子反常 |
| n=3 | $\zeta(-7) = \frac{1}{240}$ | 0.00417 | 渐近自由 |
| n=4 | $\zeta(-9) = -\frac{1}{132}$ | -0.00758 | 弱电统一 |
| n=5 | $\zeta(-11) = \frac{691}{32760}$ | 0.02109 | 强相互作用 |
| n=6 | $\zeta(-13) = -\frac{1}{12}$ | -0.083333 | 高维补偿 |
| n=7 | $\zeta(-15) = \frac{3617}{8160}$ | 0.44326 | 非微扰效应 |
| n=8 | $\zeta(-17) = -\frac{43867}{14364}$ | -3.05433 | 强耦合区域 |
| n=9 | $\zeta(-19) = \frac{174611}{6600}$ | 26.45621 | 渐近爆炸前兆 |
