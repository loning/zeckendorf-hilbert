...
|---------|---------|---------|------------|---------|
| 强力 | $R \sim |\zeta(-7)|^{-1}$ | $\omega > \omega_{\text{QCD}}$ | $\zeta(-7) = 1/240$ | $< 10^{-15}$ m |
| 弱力 | $R \sim |\zeta(-5)|^{-1}$ | $\omega_W < \omega < \omega_{\text{QCD}}$ | $\zeta(-5) = -1/252$ | $< 10^{-18}$ m |
| 电磁 | $R \sim |\zeta(-3)|^{-1}$ | $\omega_{em} < \omega < \omega_W$ | $\zeta(-3) = 1/120$ | 无限（无质量） |
| 引力 | $R \sim |\zeta(-1)|^{-1}$ | $\omega < \omega_{em}$ | $\zeta(-1) = -1/12$ | 无限（长程） |
