...
\bibitem{titchmarsh1986} E.C. Titchmarsh, \emph{The Theory of the Riemann Zeta-Function}, Second Edition, Oxford University Press (1986).
...
\bibitem{montgomery1973} H.L. Montgomery, \emph{The pair correlation of zeros of the zeta function}, Proceedings of Symposia in Pure Mathematics \textbf{24}, 181-193 (1973).

\bibitem{odlyzko1987} A.M. Odlyzko, \emph{On the distribution of spacings between zeros of the zeta function}, Mathematics of Computation \textbf{48}, 273-308 (1987).

\bibitem{katz1999} N.M. Katz, P. Sarnak, \emph{Random matrices, Frobenius eigenvalues, and monodromy}, American Mathematical Society Colloquium Publications \textbf{45} (1999).

\bibitem{voronin1975} S.M. Voronin, \emph{Theorem on the 'universality' of the Riemann zeta-function}, Izv. Akad. Nauk SSSR Ser. Mat. \textbf{39}, 475-486 (1975).

\bibitem{reed1975} M. Reed, B. Simon, \emph{Methods of Modern Mathematical Physics}, 4 volumes, Academic Press (1975-1980).

\bibitem{conway1990} J.B. Conway, \emph{A Course in Functional Analysis}, Second Edition, Springer-Verlag (1990).

\bibitem{rudin1991} W. Rudin, \emph{Functional Analysis}, Second Edition, McGraw-Hill (1991).

\bibitem{kadison1997} R.V. Kadison, J.R. Ringrose, \emph{Fundamentals of the Theory of Operator Algebras}, 4 volumes, American Mathematical Society (1997).

\bibitem{dunford1988} N. Dunford, J.T. Schwartz, \emph{Linear Operators}, 3 volumes, Wiley-Interscience (1988).

\bibitem{halmos1982} P.R. Halmos, \emph{A Hilbert Space Problem Book}, Second Edition, Springer-Verlag (1982).

\bibitem{lapidus2008} M.L. Lapidus, M. van Frankenhuijsen, \emph{Fractal Geometry, Complex Dimensions and Zeta Functions}, Second Edition, Springer (2013).

\bibitem{sabbagh2003} G. Sabbagh, \emph{The Riemann Hypothesis: A Million Dollar Problem}, Key College Publishing (2003).

\bibitem{borwein2008} P. Borwein, S. Choi, B. Rooney, A. Weirathmueller, \emph{The Riemann Hypothesis: A Resource for the Afficionado and Virtuoso Alike}, Springer (2008).

\bibitem{ingham1932} A.E. Ingham, \emph{The Distribution of Prime Numbers}, Cambridge University Press (1932).

\bibitem{davenport2000} H. Davenport, \emph{Multiplicative Number Theory}, Third Edition, Springer-Verlag (2000).

\bibitem{iwaniec2004} H. Iwaniec, E. Kowalski, \emph{Analytic Number Theory}, American Mathematical Society (2004).

\bibitem{weil1974} A. Weil, \emph{Basic Number Theory}, Third Edition, Springer-Verlag (1974).

\bibitem{lang1994} S. Lang, \emph{Algebraic Number Theory}, Second Edition, Springer-Verlag (1994).

\bibitem{mehta2004} M.L. Mehta, \emph{Random Matrices}, Third Edition, Academic Press (2004).

\bibitem{forrester2010} P.J. Forrester, \emph{Log-Gases and Random Matrices}, Princeton University Press (2010).

\bibitem{anderson2010} G.W. Anderson, A. Guionnet, O. Zeitouni, \emph{An Introduction to Random Matrices}, Cambridge University Press (2010).

\bibitem{tao2012} T. Tao, \emph{Topics in Random Matrix Theory}, American Mathematical Society (2012).

\bibitem{keating2000} J.P. Keating, N.C. Snaith, \emph{Random matrix theory and $\zeta(1/2+it)$}, Communications in Mathematical Physics \textbf{214}, 57-89 (2000).

\bibitem{berry1985} M.V. Berry, M. Tabor, \emph{Level clustering in the regular spectrum}, Proceedings of the Royal Society A \textbf{356}, 375-394 (1977).

\bibitem{gutzwiller1990} M.C. Gutzwiller, \emph{Chaos in Classical and Quantum Mechanics}, Springer-Verlag (1990).

\bibitem{sarnak1995} P. Sarnak, \emph{Quantum chaos, symmetry and zeta functions}, Current Developments in Mathematics \textbf{1995}, 127-159 (1995).

\bibitem{rudnick2004} Z. Rudnick, P. Sarnak, \emph{Zeros of principal L-functions and random matrix theory}, Duke Mathematical Journal \textbf{81}, 269-322 (1996).

\bibitem{bombieri2000} E. Bombieri, \emph{The Riemann Hypothesis}, in: The Millennium Prize Problems, American Mathematical Society (2006).

\bibitem{conrey2003} J.B. Conrey, \emph{The Riemann hypothesis}, Notices of the AMS \textbf{50}, 341-353 (2003).

\bibitem{krantz2007} S.G. Krantz, \emph{A Panorama of Harmonic Analysis}, Mathematical Association of America (2007).

\bibitem{folland1999} G.B. Folland, \emph{Real Analysis: Modern Techniques and Their Applications}, Second Edition, Wiley (1999).

\bibitem{yosida1995} K. Yosida, \emph{Functional Analysis}, Sixth Edition, Springer-Verlag (1995).

\bibitem{lax2002} P.D. Lax, \emph{Functional Analysis}, Wiley-Interscience (2002).

\bibitem{brezis2011} H. Brezis, \emph{Functional Analysis, Sobolev Spaces and Partial Differential Equations}, Springer (2011).

\bibitem{riesz1990} F. Riesz, B. Sz.-Nagy, \emph{Functional Analysis}, Dover Publications (1990).

\bibitem{dixmier1977} J. Dixmier, \emph{C*-algebras}, North-Holland (1977).

\bibitem{takesaki2002} M. Takesaki, \emph{Theory of Operator Algebras}, 3 volumes, Springer-Verlag (2002-2003).

\bibitem{pedersen1989} G.K. Pedersen, \emph{Analysis Now}, Springer-Verlag (1989).

\bibitem{murphy1990} G.J. Murphy, \emph{C*-Algebras and Operator Theory}, Academic Press (1990).
