...
def get_chapter_order():
    ...
    return [
        ...
        ("02-recursive-analysis", "第二章：递归分析理论"), 
        ("03-recursive-probability", "第三章：递归概率理论"),
        ("04-recursive-spectral-theory", "第四章：递归谱理论"),
        ("05-recursive-differential-equations", "第五章：递归微分方程理论"),
        ("06-recursive-information-theory", "第六章：递归信息理论"),
        ("07-incompatibility-theorem", "第七章：不相容定理"),
        ("08-zeckendorf-hilbert-theory", "第八章：Zeckendorf-Hilbert理论"),
        ("09-recursive-topology", "第九章：递归拓扑理论"),
        ("10-recursive-differential-geometry", "第十章：递归微分几何"),
